...
_Auto-updated by CI on every push to `main`. Last run: 2026-07-22 09:18 UTC (commit `1673c73`), averaged across 6 Lighthouse runs. Report links are temporary and expire after about 7 days — the numbers below are the permanent record._

| Page | Performance | Accessibility | Best Practices | SEO | Report |
|---|---|---|---|---|---|
| `/` | 100 | 100 | 100 | 100 | [View →](https://storage.googleapis.com/lighthouse-infrastructure.appspot.com/reports/1784711928754-17725.report.html) |
| `/tasks/:id` | 100 | 100 | 100 | 100 | [View →](https://storage.googleapis.com/lighthouse-infrastructure.appspot.com/reports/1784711929245-9618.report.html) |
